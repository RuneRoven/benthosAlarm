module github.com/RuneRoven/benthosAlarm/example

go 1.22.1

require (
	github.com/RuneRoven/benthosAlarm v0.0.0-00010101000000-000000000000
	github.com/redpanda-data/benthos/v4 v4.30.0
	github.com/redpanda-data/connect/v4 v4.30.1
)

replace github.com/RuneRoven/benthosAlarm => ../
